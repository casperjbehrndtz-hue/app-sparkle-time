  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto px-5 py-10 space-y-8">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-foreground">4. Brugsanalyse (Vercel Analytics)</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Hvis du accepterer cookies via cookiebanneret, indsamler vi anonym brugsstatistik via Vercel Analytics.
            Disse data bruges udelukkende til at forstå, hvordan værktøjet bruges (f.eks. sidevisninger og enhedstype),
            så vi kan forbedre oplevelsen.
          </p>
          <p className="text-sm text-muted-foreground leading-relaxed">
            <strong>Ingen persondata deles med Vercel.</strong> Der indsamles ingen IP-adresser, navne eller andre personhenførbare oplysninger.
            Vercel Analytics overholder GDPR og bruger ikke data til reklame eller videresalg.
          </p>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Hvis du afviser cookies i banneret, indsamles ingen analysedata overhovedet. Du kan til enhver tid ændre dit valg
            ved at rydde din browsers data.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-foreground">5. Tredjeparter</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-foreground">7. Ændringer</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
